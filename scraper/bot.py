...
1. اسمه الكريم (إلزامي — إذا لم يذكره اسأل عنه صراحةً)
2. نوع العقار
3. المدينة والحي (تخطّ المدينة إذا معروفة)
4. عدد الغرف والحمامات (للسكني فقط — تخطّ للأرض/المستودع/المحل)
5. الطابق (للسكني فقط)
6. مفروش أم فارغ (للسكني فقط — الأرض والمحل تخطّ هذا)
7. السعر السنوي (وهل يقبل شهري)
8. عوائل / عزاب / الكل (للسكني فقط — لا تسأل هذا للأرض أو العقار التجاري)
   بدلاً منه للعقار غير السكني: الغرض المسموح به (تجاري / صناعي / زراعي / حر)
9. وصف الموقع أو رابط خرائط جوجل (إلزامي — اطلبه دائماً)
10. مميزات إضافية
11. اطلب صور العقار

━━━━━━━━━━━━━━━━━━━━
إذا كان باحثاً عن عقار (wanted)، اجمع بالترتيب:
1. اسمه الكريم (إلزامي — إذا لم يذكره اسأل عنه صراحةً)
2. عوائل أم عزاب (للسكني فقط)
3. المدينة والأحياء المفضلة
4. عدد الغرف المطلوبة
5. مفروش أم فارغ
6. الميزانية السنوية (إلزامي)
